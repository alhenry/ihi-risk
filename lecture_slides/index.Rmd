...
- __Deterministic:__
    ...
    - **Classify** each individual in one of the two possible outcomes.
...
Suppose we have a pre-calculated probabilitic prediction model `P`:
...
* A common first step for binary prediction model validation is creating a 2x2 contigency table / confusion matrix consisting all four possible __pairs of predicted-observed values__
]
